...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 0.5em; margin-top:0.25rem">
        ...
        if show_landing_message and featured_image_base64:
            ...
            header_content += f"""
            <div style="flex: 1; min-width: 200px; margin-left: 1rem; margin-right: 0.5rem; margin-top:0.5rem; margin-bottom:-0.5rem;">"""
