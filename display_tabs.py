...
def display_matchup_summary(deck_name, set_name, working_df):
    ...
    with col1:
       ...
       <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 10px;  border-radius: 8px; height: 100px;">
            ...
            <div style="font-size: 2.5rem; font-weight: bold; color: #84cc15; line-height: 0.7;">{favorable_share_norm:.1f}%</div>
    ...
    with col2:
        ...
        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 10px;  border-radius: 8px; height: 100px;">
            ...
            <div style="font-size: 2.5rem; font-weight: bold; color: #fdc500; line-height: 0.7;">{even_share_norm:.1f}%</div>
            <div style="font-size: 1rem;">of meta</div>
        </div>
        """, unsafe_allow_html=True)
    ...
    with col3:
        ...
        <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; padding: 10px; border-radius: 8px; height: 100px;">
            ...
            <div style="font-size: 2.5rem; font-weight: bold; color: #fd6c6c; line-height: 0.7;">{unfavorable_share_norm:.1f}%</div>
            <div style="font-size: 1rem; ">of meta</div>
        </div>
        """, unsafe_allow_html=True)
