...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        <div style="display: flex; flex-wrap: wrap; justify-content: center; align-items: center; gap: 1rem; margin: -0.5rem 0 0.5rem 0; text-align: center;">
        ...
        header_content += f"""<div style="text-align: center; font-family: 'Nunito', sans-serif; font-weight: 900; font-style: italic; line-height: 1; word-wrap: break-word; font-size: 3rem; margin: 1rem;">{format_deck_name(deck_info['deck_name'])}</div></div>
