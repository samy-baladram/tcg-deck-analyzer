...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 1em; margin-top:0.25rem">
            <div style="margin-right: 0rem; margin-left:0rem; margin-bottom: -0.5rem;">
        ...
        if show_landing_message and featured_image_base64:
            ...
            header_content += f"""
            <div style="flex: 1; min-width: 200px; margin-left: 1rem; margin-right: 1rem; margin-bottom: -1rem; align-self: flex-end; padding-bottom: 20px;">"""
        else:
        ...
        if show_landing_message and featured_image_base64:
            header_content += f"""
                <div style="margin-bottom: -2rem; margin-top: -1.1rem;">
