...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        if show_landing_message and featured_image_base64:
            ...
            <div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 1em; margin-top:0.25rem">
                <div style="margin-right: 0rem; margin-left:0rem; margin-bottom: -1rem;">
                    <img src="data:image/png;base64,{header_image}" style="width: 100%; max-width: 4500px; height: auto; border-radius: 10px;">
                </div>"""
            ...
            header_content += f"""
            <div style="flex: 1; min-width: 200px; margin-left: 1rem; margin-right: 0.5rem; ">"""
        ...
        # Add the deck name
        header_content += f"""
                <h1 style="margin-bottom:-0.8rem; margin-top:0.5rem; text-align: center; font-family: 'Nunito', sans-serif; font-weight: 900; font-style: italic; line-height: 1; word-wrap: break-word;">{format_deck_name(deck_info['deck_name'])}</h1>
            </div>
        </div>"""
