...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        <div>
                <img src="data:image/png;base64,{header_image}" style="max-width: 23rem; margin-top: -17.7rem; margin-bottom: -1rem; width: 85%; height: auto; border: 0px solid #57585F; border-radius: 40px 40px 0px 0px; object-position: bottom;">
        </div>
        </div>"""
        # header_content = f"""
