...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        # Add the deck name
        header_content += f"""
                <h2 style="text-align: center; font-family: 'Nunito', sans-serif; font-weight: 900; font-style: italic; line-height: 0.9; word-wrap: break-word;">{format_deck_name(deck_info['deck_name'])}</h2>
            </div>
        </div>"""
