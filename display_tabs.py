...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        if show_landing_message and featured_image_base64:
            ...
            header_content += f"""
            <div style="flex: 1; min-width: 200px; margin-left: 0.8rem; margin-right: 0.8rem;  align-self: flex-end; padding-bottom: 20px;">"""
        else:
            # When no featured image, keep normal centering
            header_content += f"""
            <div style="flex: 1; min-width: 200px; margin-left: 0.8rem; margin-right: 0.8rem;  margin-top:0rem;">"""
