...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 1.5rem; margin-top:0.25rem">
            <div style="margin-right: 1rem; margin-left:0.5rem; margin-bottom: -20px;">
        ...
        if show_landing_message and featured_image_base64:
            header_content += f"""
                <div style="margin-bottom: -1.2rem; margin-top: 0rem;">
                    <img src="data:image/png;base64,{featured_image_base64}" style="max-width: 100%; height: auto; max-height: 70px;">
                </div>"""
