...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        <div style="display: flex; flex-wrap: wrap; align-items: center; margin-bottom: 1rem; margin-top:0.25rem">
        ...
        if show_landing_message and featured_image_base64:
            ...
            header_content += f"""
            <div style="flex: 1; min-width: 200px; margin-bottom: -3rem; align-self: flex-end; padding-bottom: 20px;">"""
        else:
