...
def display_deck_header(deck_info, results):
    ...
    if header_image:
        ...
        header_content = f"""
        <div style="display: flex; justify-content: center; align-items: center; margin: 0rem 0 0.5rem -1rem; text-align: center;">
            <div style="min-width: 200px;">
                <img src="data:image/png;base64,{header_image}" style="max-width: 400px; width: 100%; height: auto; border: 0px solid #57585F; border-radius: 5px;">
            </div>
        </div>"""
