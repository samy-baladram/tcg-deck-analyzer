...
def display_meta_overview_table_with_buttons():
    ...
    for idx, row in meta_df.iterrows():
        ...
        with col1:
            ...
            if row['pokemon_url1']:
                icons_html += f'<img src="{row["pokemon_url1"]}" style="height: 28px; max-width: 50%; border-radius: 0px;">'
            
            if row['pokemon_url2']:
                icons_html += f'<img src="{row["pokemon_url2"]}" style="height: 28px; max-width: 50%; border-radius: 0px;">'
