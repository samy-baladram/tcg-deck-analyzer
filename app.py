...
if 'analyze' in st.session_state and selected_option:
    ...
    st.markdown(f"""
    <div style="display: flex; align-items: center; margin-bottom: 0rem;">
        <img src="data:image/png;base64,{img_base64_1}" style="width: 49%; max-width: 200px; height: auto; margin-right: 0.5%; margin-bottom:-2.3em;">
        <img src="data:image/png;base64,{img_base64_2}" style="width: 49%; max-width: 200px; height: auto; margin-right: 0em; margin-bottom:-2.3em;">
    </div>
