    ...
    if os.path.exists(config['banner_path']):
        ...
        if banner_base64:
            st.markdown(f"""<div style="width:100%; text-align:left;">
                <img src="data:image/png;base64,{banner_base64}" style="width:100%; max-width:200px; margin-top: -30px; margin-bottom:-30px;">
            </div>
            """, unsafe_allow_html=True)
    else:
        st.markdown(f"### {config['fallback_title']}")
...
def display_counter_picker_sidebar():
    ...
    if os.path.exists(config['banner_path']):
        ...
        if banner_base64:
            st.markdown(f"""<div style="width:100%; text-align:left;">               
                <img src="data:image/png;base64,{banner_base64}" style="width:100%; max-width:200px; margin-top: -20px; margin-bottom:0px;">
            </div>
            """, unsafe_allow_html=True)
    else:
