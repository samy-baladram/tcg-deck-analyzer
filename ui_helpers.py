...
def render_sidebar_from_cache():
    ...
    if os.path.exists(trending_banner_path):
        ...
        <div style="width:100%; text-align:center;">
            <img src="data:image/png;base64,{trending_banner_base64}" style="width:100%; max-width:350px; margin-bottom:-5px;">
        </div>
        """, unsafe_allow_html=True)
    else:
    ...
    if 'performance_data' in st.session_state and not st.session_state.performance_data.empty:
            ...
            if header_image:
                ...
                <div style="width: 100%; margin-bottom: -1rem;">
                    <img src="data:image/png;base64,{header_image}" style="width: 100%; height: auto; border: 5px solid #000; border-radius: 8px;z-index:-1;">
                </div>
                """, unsafe_allow_html=True)
            else:
                st.markdown("""
