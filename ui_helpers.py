...
def create_deck_options():
    ...
    if 'performance_data' in st.session_state and not st.session_state.performance_data.empty:
        ...
        for _, deck in top_performing_decks.iterrows():
            ...
            display_name = "![Screenshot of a comment on a GitHub issue showing an image, added in the Markdown, of an Octocat smiling and raising a tentacle.](https://myoctocat.com/assets/images/base-octocat.svg)" + deck['displayed_name']
