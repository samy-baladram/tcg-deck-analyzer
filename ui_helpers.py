    ...
    try:
        ...
        if header_image:
            ...
            <div style="width: 100%; margin-top: -5px; margin-bottom: -5px; position: relative;">
                <img src="data:image/png;base64,{header_image}" style="width: 100%; height: auto; border: 2px solid #000; border-radius: 8px; z-index:-1;">
                <div style="position: absolute; bottom: 0px; right: 0px; background-color: rgba(0, 0, 0, 0.7); color: white; padding: 2px 6px; border-radius: 6px 0px 0px 8px; font-size: 0.6rem; font-weight: 700;">
                    {stats_text}
                </div>
            </div>
            """, unsafe_allow_html=True)
